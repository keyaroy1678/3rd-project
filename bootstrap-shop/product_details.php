			...
			<div class="span6">
				...
				<form class="form-horizontal qtyFrm">
				  <div class="control-group">
					<label class="control-label"><span>222.00tk</span></label>
					<div class="controls">
				...
				<ul class="thumbnails">
					<li class="span3">
					  <div class="thumbnail">
						...
						<div class="caption">
						  <h5>Manicure &tk; Pedicure</h5>
						  <p> 
							Lorem Ipsum is simply dummy text. 
						  </p>
						  <h4 style="text-align:center"><a class="btn" href="product_details.html"> <i class="icon-zoom-in"></i></a> <a class="btn" href="#">Add to <i class="icon-shopping-cart"></i></a> <a class="btn btn-primary" href="#">222.00tk</a></h4>
						</div>
					  </div>
					</li>
					<li class="span3">
